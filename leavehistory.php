                                ...
                                <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="200">Approvel by Director</th>
...
<?php 
$eid=$_SESSION['eid'];
$sql = "SELECT LeaveType,ToDate,FromDate,Description,PostingDate,AppSecHeadStatus,AppSecHeadDate,AppDirector from tblleaves where empid=:eid";
