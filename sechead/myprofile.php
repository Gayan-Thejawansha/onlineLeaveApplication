...
$sql="update tblemployees set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,Phonenumber=:mobileno,Category=:category,Nic=:nic,Sechead=:sechead,Institute=:istitute where EmailId=:eid";
...
$query->bindParam(':mobileno',$mobileno,PDO::PARAM_STR);
$query->bindParam(':sechead',$sechead,PDO::PARAM_STR);
...
<input id="sechead" name="sechead" type="text"  value="<?php echo htmlentities($result->Sechead);?>" autocomplete="off" required>
</div>              

<div class="input-field col m6 s12">
<label for="nic">Nic</label>
<input id="nic" name="nic" type="text"  value="<?php echo htmlentities($result->Nic);?>" autocomplete="off" required>
</div>

<div class="input-field col m6 s12">
<label for="institute">Institute</label>
<input id="institute" name="institute" type="text"  value="<?php echo htmlentities($result->Institute);?>" autocomplete="off" required>
</div>
