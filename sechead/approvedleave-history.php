                                ...
                                <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="120">App Sec Head</th>
                                            <th width="120">App Director</th>
...
<?php 
$status=1;
$sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.AppSecHead,tblleaves.AppDirector from tblleaves join tblemployees on tblleaves.empid=tblemployees.id where tblleaves.AppSecHead=:appsechead order by lid desc";
