                             ...
                             <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="120">AppSecHead</th>
                                            <th width="120">AppDirector</th>
                                            <th align="center">Action</th>
                                        </tr>
                                    </thead>
                                 
                                    <tbody>
<?php $sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.AppSecHead,tblleaves.AppDirector from tblleaves join tblemployees on tblleaves.empid=tblemployees.id order by lid desc limit 6";
      ...
      ?>  
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($result->PostingDate);?></td>
                                                                       <td><?php $appsechead=$result->AppSecHead;
if($appsechead==1){
                                             ?>
