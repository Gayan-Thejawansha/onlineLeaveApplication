...
$category='Director'; 
$nic=$_POST['nic'];  
$sechead=$_POST['sechead'];
$institute=$_POST['institute'];
$status=1;

$sql="INSERT INTO tblemployees(EmpId,FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,Phonenumber,Category,Nic,Sechead,Institute,Status,permissionLevel,secHeadId) VALUES(:empid,:fname,:lname,:email,:password,:gender,:dob,:department,:address,:mobileno,:category,:nic,:sechead,:institute,:status,'Director',1)";
...
$query->bindParam(':sechead',$empid,PDO::PARAM_STR);
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Add Directors</title>
...
error:function (){}
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Add Director</div>
                    </div>
...
<label for="empcode">Director Code(Must be unique)  Format: Name_0xx</label>
...
<input id="nic" name="nic" type="text" autocomplete="off" required>
</div>

<!--div class="input-field col m6 s12">
<label for="sechead">Sectional Head</label>
<input id="sechead" name="sechead" type="text" autocomplete="off" required>
</div-->

<div class="input-field col m6 s12">
<label for="institute">Institute</label>
<input id="institute" name="institute" type="text" autocomplete="off" required>
</div>
