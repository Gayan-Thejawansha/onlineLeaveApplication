...
$sql="update tblemployees set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,Phonenumber=:mobileno,Category=:category,Nic=:nic,Sechead=:sechead,Institute=:institute where id=:eid";
...
<input id="institute" name="institute" type="text"  value="<?php echo htmlentities($result->Nic);?>" autocomplete="off" required>
</div>
